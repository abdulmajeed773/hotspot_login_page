 function rem(){
		...
		var speed = document.getElementById('domain').value;
		...
		document.cookie = 'spexd='+spexd+';expires='+expire+'';
     ...
     if(str.indexOf("spexd") !== -1){
        spexd = name_value.split('=');
        spexd = spexd[1];
        }
        ...
        if(uname != ""){
        document.cookie = 'error=1;expires='+expires+'';
        window.location.href='login?username='+uname+'&password='+paswd+'&domain='+spexd+'';
        }
